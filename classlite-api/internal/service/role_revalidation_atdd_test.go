...
func TestServiceMutation_AC13_DemotedUser_RejectedDespiteValidJWT(t *testing.T) {
	...
	if _, err := svc.AdminInviteStaff(context.Background(), tc, service.AdminInviteStaffInput{Email: "newteacher@example.com", Role: "teacher"}); err != nil {
	...
	_, err := svc.AdminInviteStaff(context.Background(), tc, service.AdminInviteStaffInput{Email: "another@example.com", Role: "teacher"})
